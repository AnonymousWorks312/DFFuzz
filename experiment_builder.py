...
def _get_model_v2(params, experiment):
    ...
    if params.model == "LeNet5":
        ...
        model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
    elif params.model == "rq3_LeNet5":
        model = keras.models.load_model(
            'models/mnist_lenet5_0.8tr/train_on_0.2tr/keras_mnist_lenet5_model.014-0.9783.h5')
        model.load_weights('rq3_m2prime/rq3_mnist_lenet5_tr/model.011-0.9926_on_deeprefuzz.h5')
        model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
    elif params.model == "rq3_LeNet5_onv1":
        model = keras.models.load_model(
            'models/mnist_lenet5_0.8tr/train_on_0.2tr/keras_mnist_lenet5_model.014-0.9783.h5')
        model.load_weights('rq3_m2prime/rq3_mnist_lenet5_tr/model.016-0.9775-ondeeprefuzz_onv1.h5')
        model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
    elif params.model == "rq3_vgg16":
        model = keras.models.load_model(
            'models/cifar10_vgg16_0.8tr/train_on_0.2tr/keras_cifar10_vgg16_model.017-0.8788.h5')
        model.load_weights('rq3_m2prime/rq3_cifar10_vgg16_tr/model.020-0.8841-ondeeprefuzz.h5')
        model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
    elif params.model == "rq3_vgg16_onv1":
        model = keras.models.load_model(
            'models/cifar10_vgg16_0.8tr/train_on_0.2tr/keras_cifar10_vgg16_model.017-0.8788.h5')
        model.load_weights('rq3_m2prime/rq3_cifar10_vgg16_tr/model.007-0.8846-ondeeprefuzz_onv1.h5')
        model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
    elif params.model == "rq3_Alexnet":
        model = keras.models.load_model('models/fm_alexnet_0.8tr/train_on_0.2tr/keras_fm_alexnet_model.016-0.9034.h5')
        model.load_weights('rq3_m2prime/rq3_fm_alexnet_tr/model.020-0.9165-ondeeprefuzz.h5')
        model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
    elif params.model == "rq3_Alexnet_onv1":
        model = keras.models.load_model('models/fm_alexnet_0.8tr/train_on_0.2tr/keras_fm_alexnet_model.016-0.9034.h5')
        model.load_weights('rq3_m2prime/rq3_fm_alexnet_tr/model.011-0.9105-ondeeprefuzz_onv1.h5')
        model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
    elif params.model == "rq3_resnet18":
        model = keras.models.load_model(
            'models/svhn_resnet18_0.8tr/train_on_0.2tr/keras_svhn_resnet18_model.003-0.9193.h5')
        model.load_weights('rq3_m2prime/rq3_svhn_resnet18_tr/model.030-0.9140-ondeeprefuzz.h5')
        model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
...
def _get_model(params, experiment):
    import os
    os.environ['KMP_DUPLICATE_LIB_OK'] = 'True'
    if params.model == "LeNet5" or params.model == "rq3_LeNet5" or params.model == "rq3_LeNet5_onv1":
        # import tensorflow as tf
        model = keras.models.load_model(
        ...
        model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
        # model.summary()
    elif params.model == "vgg16" or params.model == "rq3_vgg16" or params.model == "rq3_vgg16_onv1":
        # import tensorflow as tf
        model = keras.models.load_model(
        ...
        model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
        # model.summary()
    elif params.model == "resnet18" or params.model == "rq3_resnet18":
        model = keras.models.load_model(
        ...
        model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
    elif params.model == "Alexnet" or params.model == "rq3_Alexnet" or params.model == "rq3_Alexnet_onv1":
