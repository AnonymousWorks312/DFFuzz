...
def testcaselist2failureid(test_case_list):
    ...
    failure_ids = []
    for i in range(len(test_case_list)):
        failure_ids.append((test_case_list[i].source_id,test_case_list[i].m1_predict_label,test_case_list[i].m2_predict_label))
...
def testcaselist2pastandfailureid(test_case_list):
    ...
    history_ids_in_tree = []
    for i in range(len(test_case_list)):
        failure_tuple = (test_case_list[i].source_id,test_case_list[i].m1_predict_label,test_case_list[i].m2_predict_label)
