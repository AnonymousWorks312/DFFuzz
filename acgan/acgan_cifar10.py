...
class ACGAN():
    ...
    def save_model(self, epoch):
        self.discriminator.save_weights('acgan_models_cifar10/discriminator_epoch' + str(epoch + 1) + ".h5", True)
        self.generator.save_weights('acgan_models_cifar10/generator_epoch' + str(epoch + 1), True)
        # def save(model, model_name):
        #
        #     weights_path = "dcgan_models_mnist/%s_weights.hdf5" % model_name
    ...
    def test(self, weight_path):
        ...
        print(self.discriminator.predict(X_train[0:2, :, :]))
...
if __name__ == '__main__':
    ...
    acgan.test("discriminator_epoch100.h5")
